...
<body>
  <!--Header-->
	...
	<div id="fondoBlanco" >
	<form action="ServletPromociones" enctype="multipart/form-data"
		method="post">
		<hr>
		<fieldset>
			<%
			...
			<legend> Contenido de promociones</legend>

			<p>
				Descripcion: <input type="text" name="descripcion" />
				Descuento:<input type="number" name="descuento" />
			</p>
			<br>
			<br>
	 ...
	 <p>
			...
			<input type="submit" value="Dar de alta la Promocion" />
			<ul>
