...
<body>
  <!--Header-->
	...
	<div id="fondoBlanco" >
	<form action="ServletBuscarCursos" enctype="multipart/form-data" method="post">
		<hr>
		<fieldset>
			<%//<form name="formulario" action="ServletBuscarCursos" class="form-horizontal mitad" method="post">
			 %>
		...
		<div class="container">
			...
			<!-- You can make it whatever width you want. I'm making it full width
             on <= small devices and 4/12 page width on >= medium devices -->
				...
				<input type="radio" name="campo" value="titulo"  /> buscar por titulo
		        <br>
		        <input type="radio" name="campo" value="precio"  /> buscar por precio
		        <br>
		        <input type="radio" name="campo" value="tematica"  /> buscar por tema
		        <br>
					
					<p> esctibir campo de busqueda: <input type="text" name="busqueda"/> </p>
